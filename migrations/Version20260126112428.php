 ...
 */
final class Version20260126112428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract (id INT AUTO_INCREMENT NOT NULL, status INT NOT NULL, deplacement TINYINT NOT NULL, transport_fee_taken TINYINT NOT NULL, lunch_taken TINYINT NOT NULL, host_taken TINYINT NOT NULL, bonus TINYINT NOT NULL, work_hours VARCHAR(255) NOT NULL, planned_activities VARCHAR(8000) NOT NULL, sharing_token VARCHAR(255) DEFAULT NULL, token_exp_date DATETIME DEFAULT NULL, pdf_unsigned VARCHAR(255) DEFAULT NULL, pdf_signed VARCHAR(255) DEFAULT NULL, student_id INT NOT NULL, tutor_id INT DEFAULT NULL, session_id INT NOT NULL, organisation_id INT DEFAULT NULL, INDEX IDX_E98F2859CB944F1A (student_id), INDEX IDX_E98F2859208F64F1 (tutor_id), INDEX IDX_E98F2859613FECDF (session_id), INDEX IDX_E98F28599E6B1585 (organisation_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, is_verified TINYINT NOT NULL, discr VARCHAR(255) NOT NULL, personal_email VARCHAR(320) DEFAULT NULL, level_id INT DEFAULT NULL, tel_mobile VARCHAR(15) DEFAULT NULL, tel_other VARCHAR(15) DEFAULT NULL, INDEX IDX_8D93D6495FB14BA7 (level_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
